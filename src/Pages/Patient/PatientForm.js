  ...
  state = {
    ...
    onSubmit = formValues => {
      ...
      if(this.state.investigationFiles !== null){
        patient_form.append('investigationfiles', this.state.investigationFiles, this.state.investigationFiles.name);
      }
      ...
      if(formValues.NID !== undefined || formValues.NID !== null){patient_form.append('NID', formValues.NID);}
      ...
      if(formValues.Emergency !== undefined || formValues.Emergency !== null){patient_form.append('Emergency', formValues.Emergency);}
      ...
      if(formValues.blood_groups !== undefined || formValues.blood_groups !== null){patient_form.append('blood_groups', formValues.blood_groups);}
      patient_form.append('blood_groups', "");
      if(formValues.Weight !== undefined || formValues.Weight !== null){patient_form.append('Weight', formValues.Weight);}
      patient_form.append('Weight', '');
      if(formValues.Height !== undefined || formValues.Height !== null){patient_form.append('Height', formValues.Height);}
      patient_form.append('Height', '');
      if(formValues.BMI !== undefined || formValues.BMI !== null){patient_form.append('BMI', formValues.BMI);}
      ...
      if(formValues.grading !== undefined || formValues.grading !== null){patient_form.append('grading', formValues.grading);}
      patient_form.append('grading', '');
      if(formValues.staging !== undefined || formValues.staging !== null){patient_form.append('staging', formValues.staging);}
      patient_form.append('staging', '');
      if(formValues.Treatmentapproach !== undefined || formValues.Treatmentapproach !== null){patient_form.append('Treatmentapproach', formValues.Treatmentapproach);}
    ...
    renderForm = () => {
        return (
            ...
            <h3 className="heading-tertiary" >Personal Information</h3>
              <p>Profile Image<input  name="patient_image"  type='file' id="image"  accept="image/*" onChange= {(e)=> this.setState({image:e.target.files[0]})}/></p>
            ...
            <div class="field">
              ...
              <Field name="registration" component={this.renderInput} type='text' placeholder="Registration Number"/>
            ...
            <div className="two fields">
              ...
              <Field name="Height" component={this.renderInput} type='text' placeholder="Height in ft and inch  " />
            </div>
              <Field name="BMI" component={this.renderInput} type='number' placeholder="BMI" />
              <div className=" fields">
                <label className="label" >Blood Group:</label>
                  <Field name="blood_groups" component={this.renderInput} type="radio" value="A+" /><label>A+</label>
                  <Field name="blood_groups" component={this.renderInput} type="radio" value="A-"/><label>A-</label>
                  <Field name="blood_groups" component={this.renderInput} type="radio" value="B+"/><label>B+</label>
                  <Field name="blood_groups" component={this.renderInput} type="radio" value="B-"/><label>B-</label>
                  <Field name="blood_groups" component={this.renderInput} type="radio" value="O+"/><label>O+</label>
                  <Field name="blood_groups" component={this.renderInput} type="radio" value="O-"/><label>O-</label>
                  <Field name="blood_groups" component={this.renderInput} type="radio" value="AB+"/><label>AB+</label>
                  <Field name="blood_groups" component={this.renderInput} type="radio" value="AB-"/><label>AB-</label>
                </div>
            <Field name="Concomitant" component={this.renderTextarea} rows='5' placeholder='Concomitant Diseases'/>
            <Field name="familyhistory" component={this.renderTextarea} rows='5' placeholder='Family Medical History' />
            <p>Family Medical History File<input  name="historyfiles"  type='file' id="historyfiles"  onChange= {(e)=> this.setState({historyFiles:e.target.files[0]})}/></p>
            <Field name="familyhistoryofmalignancy" component={this.renderTextarea} rows='5' placeholder='Family History of Malignancy'/>
            <Field name="personalhistory" component={this.renderTextarea} rows='5' placeholder='Personal Medical History'/>
            <Field name="pasthistorydisease" component={this.renderTextarea} rows='5' placeholder='Past Disease History'/>
            <Field name="Drughistory" component={this.renderTextarea} rows='5' placeholder='Drug History'/>
            <Field name="Physicalexamfindings" component={this.renderTextarea} rows='6' placeholder='Physical Exam Findings'/>
            <p>Physical Exam Findings File<input  name="physicalexamfiles"  type='file' id="physicalexamfiles"  onChange= {(e)=> this.setState({physicalexamFiles:e.target.files[0]})}/></p>
            ...
            <p>Investigation File<input  name="investigationfiles"  type='file' id="investigationfiles"  onChange= {(e)=> this.setState({investigationFiles:e.target.files[0]})}/></p>
            ...
            <Field name="histopathology" component={this.renderTextarea} rows='4' placeholder='Histopathology'/>
            ...
            <Field name="ENDOSCOPYofupperGIT" component={this.renderTextarea} rows='4' placeholder='Endoscopy of Upper GIT'/>
            <Field name="COLONOSCOPY" component={this.renderTextarea} rows='4' placeholder='Colonoscopy'/>
            <Field name="Nasopharyngoscopy" component={this.renderTextarea} rows='4' placeholder='Nasopharyngoscopy'/>
            ...
            <Field name="papsmearcytology" component={this.renderTextarea} rows='4' placeholder='Pap Smear Cytology'/>
            ...
            <Field name="ECHO_CARDIOgraphy" component={this.renderTextarea} rows='4' placeholder='Echocardiography'/>
            <Field name="Bone_marrow_Study" component={this.renderTextarea} rows='4' placeholder='Bone Marrow Study'/>
            <Field name="LDH" component={this.renderTextarea} rows='4' placeholder='LDH'/>
            <Field name="SERUM_PROTEIN_ELECTROPHORESIS" component={this.renderTextarea} rows='4' placeholder='Serum Protein Electrophoresis'/>
            <Field name="additionaltest" component={this.renderTextarea} rows='4' placeholder='Additional Test'/>
            
              <div className=" fields">
                <label className="label" >Staging:</label>
                    <Field name="staging" component={this.renderInput} type="radio" value="1"/><label>I</label>
                    <Field name="staging" component={this.renderInput} type="radio" value="2"/><label>II</label>
                    <Field name="staging" component={this.renderInput} type="radio" value="3"/><label>III</label>
                    <Field name="staging" component={this.renderInput} type="radio" value="4"/><label>IV</label>
                </div>
              <div className=" fields">
              <label className="label" >Grading:</label>
                    <Field name="grading" component={this.renderInput} type="radio" value="1"/><label>I</label>
                    <Field name="grading" component={this.renderInput} type="radio" value="2"/><label>II</label>
                    <Field name="grading" component={this.renderInput} type="radio" value="3"/><label>III</label>
              </div>
  
            <p>Treatment Approach:</p>
            <div className=" fields">
                <label  className="label">Curative:</label>
                    <Field name="Treatmentapproach" component={this.renderInput} type="radio" value="surgery"/><label>Surgery</label>
                    <Field name="Treatmentapproach" component={this.renderInput} type="radio" value="chemotherapy"/><label>Chemotherapy</label>
                    <Field name="Treatmentapproach" component={this.renderInput} type="radio" value="immunotherapy"/><label>Immunotherapy</label>
                    <Field name="Treatmentapproach" component={this.renderInput} type="radio" value="hormone"/><label>Hormone Therapy</label>
                    <Field name="Treatmentapproach" component={this.renderInput} type="radio" value="other"/><label>Other</label>
                </div>
            <div className=" fields">
            ...
            <Field name="additionaltreatment" component={this.renderTextarea} rows='6' placeholder='Additional Treatment'/>
            ...
            <Field name="additionalinformation" component={this.renderTextarea} rows='8' placeholder='Additional Information'/>
            <p>Report File<input  name="reportsfiles"  type='file' id="reportsfiles"  onChange= {(e)=> this.setState({reportsFiles:e.target.files[0]})}/></p>
            <p>Additional File<input  name="additionalfiles"  type='file' id="additionalfiles"  onChange= {(e)=> this.setState({additionalFiles:e.target.files[0]})}/></p>
